...
export class CourseRoute implements Routes {
  ...
  private initializeRoutes() {
    ...
    this.router.post(`${this.path}/addCourseRating`, this.course.addCourseRating);
    this.router.post(`${this.path}/dashRatingCourse`, this.course.dashRatingCourse);
    this.router.post(`${this.path}/dashViewedCourse`, this.course.dashViewedCourse);
    ...
    this.router.get(`${this.path}/getRecommendedCourse/:id`, this.course.getRecommendedCourse);
    this.router.post(`${this.path}/addModule`, this.course.createCourseModule);
    this.router.post(`${this.path}/addCourseProgress`, this.course.addCourseProgress);
    this.router.post(`${this.path}/courseComplete`, this.course.completeCourseProgress);
    this.router.post(`${this.path}/updateCourseProgress`, this.course.updateCourseProgress);
    this.router.post(`${this.path}/getCourseProgress`, this.course.getCourseProgress);
    // this.router.put(
    //   `${this.path}/coursePurchase/:id`,
    //   this.course.coursePurchase
    // );

    this.router.post(`${this.path}/getRecentViewVideos`, this.course.getRecentViewVideos);
    ...
    this.router.put(`${this.path}/:id/removeChapter`, this.course.removeChapter);
    this.router.put(`${this.path}/:id/updateChapter`, this.course.updateChapter);
    ...
    this.router.delete(`${this.path}/:id/moduleDelete`, this.course.deleteModule);
